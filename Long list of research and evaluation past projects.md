...
A programme aimed at mobilising private finance to promote renewable energy and energy efficiency pro- jects in middle income countries. The primary focus of the evaluation was an assessment of the effective- ness and relevance of GCPF’s activities on low carbon development, identifying efficiencies (and inefficiencies) in processes and providing learning for future. This relied on a mixed method, theory-based evaluation design, collecting primary and secondary evidence from performance and monitoring information, operational and market benchmarking, stakeholder consultations and case studies.
